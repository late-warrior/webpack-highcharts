var annotateMod = require('./plugins/annotations/annotations');
var exportMod = require('./plugins/excel-export/excel');
...
function annotateChart() {
    ...
    var chart = new ht.StockChart(options);
}
